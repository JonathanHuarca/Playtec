...
const { NODE_ENV, SIAGIE_URL, SIAGIE_URL_PROD } = process.env;
const BASE_URL = NODE_ENV === 'production' ? SIAGIE_URL_PROD : SIAGIE_URL;
const api = apiAdapter_1.default(BASE_URL);
const siagie = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.default = siagie;
//# sourceMappingURL=siagie.controller.js.map