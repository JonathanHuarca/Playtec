...
const { NODE_ENV, CALENDARY_URL, CALENDARY_URL_PROD } = process.env;
const BASE_URL = NODE_ENV === 'production' ? CALENDARY_URL_PROD : CALENDARY_URL;
const api = apiAdapter_1.default(BASE_URL);
const calendary = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
//# sourceMappingURL=calendary.controller.js.map